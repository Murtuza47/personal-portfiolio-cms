...
export interface ApiAboutComponentAboutComponent extends Schema.SingleType {
  collectionName: 'about_components';
  info: {
    singularName: 'about-component';
    pluralName: 'about-components';
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::about-component.about-component',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiAboutPageAboutPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    job_component: Attribute.Component<'main.job-history'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiContactComponentContactComponent extends Schema.SingleType {
  collectionName: 'contact_components';
  info: {
    singularName: 'contact-component';
    pluralName: 'contact-components';
    displayName: 'contact-component';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::contact-component.contact-component',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFooterComponentFooterComponent extends Schema.SingleType {
  ...
  attributes: {
    ...
    social_links: Attribute.Component<'main.socal-links', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiJobComponentJobComponent extends Schema.SingleType {
  collectionName: 'job_components';
  info: {
    singularName: 'job-component';
    pluralName: 'job-components';
...
export interface ApiServiceComponentServiceComponent extends Schema.SingleType {
  collectionName: 'service_components';
  info: {
    singularName: 'service-component';
    pluralName: 'service-components';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::service-component.service-component',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
